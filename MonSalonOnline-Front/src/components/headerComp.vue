 ...
 <div class="bg-gray-100 font-sans w-full  m-0">
    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between py-4">
        <div>
          <a href="#" class="flex items-center  text-lg font-semibold text-black dark:text-white">
        ...
        <div v-if="checkLogin()" class="flex gap-10  sm:flex sm:items-center">
      ...
      <div v-if="checkLogin()" class="flex gap-10  sm:flex sm:items-center">
        <div class="hidden sm:flex sm:items-center">
          ...
          <a href="/" @click="logout" id="LogIn" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Logout</a>
      ...
      <div v-if="!checkLogin()">
        <div class="hidden sm:flex sm:items-center">
          ...
          <a href="/login" id="LogIn" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">LogIn</a>

          <a href="/signup" id="signUp"  class="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</a>
        </div>
      </div>
...
<script >
 export default {
  methods: {
    checkLogin() {
        return localStorage.getItem('reference') !== null;
      },
      logout(){
